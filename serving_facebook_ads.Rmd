...
advertising <- read.csv("~/Clients/MUSA_Teaching_and_Admin/MUSA_507_2020/people_ML/advertising_clean.csv")
...
**Practice explaining the values of the coefficients:**

Use the `exp()` function to exponentiate a coefficeint and produce an 'odds ratio'. A fixed effect coefficient which exponentiates to a value of, say `0.25` would be explained as follows:

"All else equal, a person having 'characteristic X' reduces the likelihood of clicking by 25%."
...
Is it useful? Is it overfit? Is it underfit? What does the y=x line represent?
...
**Are there particular types of error which are more damaging? What outcomes do we want to maximize or minimize?**
