...
Use the `exp()` function to exponentiate a coefficeint and produce an 'odds ratio' relative to a value of 1. A fixed effect coefficient which exponentiates to a value of, say `0.25` would be explained as follows:
